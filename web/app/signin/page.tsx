...
const features = [
  { icon: Monitor, text: "100% client-side processing" },
  { icon: Layers, text: "ZIP & PMTiles output" },
  { icon: Globe, text: "Flat, Mercator & isometric projections" },
];
    ...
    <div className="mx-auto grid w-full max-w-6xl flex-1 overflow-hidden md:grid-cols-2">
      ...
      <div className="relative hidden bg-card md:flex md:flex-col md:items-center md:justify-center md:p-12">
        ...
        <div className="relative z-10 max-w-md">
          ...
          <div className="flex items-center gap-3">
            <svg
              viewBox="0 0 32 32"
              className="text-primary h-16 w-16 drop-shadow-[0_0_24px_rgba(var(--secondary-fg-rgb),0.4)]"
              role="img"
            ...
            <h1
              className="font-[family-name:var(--font-geist-mono)] text-primary text-5xl font-bold tracking-tight"
              style={{ textShadow: "0 0 30px rgba(var(--secondary-fg-rgb),0.3)" }}
            >
              tileforge
            </h1>
          </div>
      ...
      <div className="flex flex-col items-center justify-center p-6 md:p-12">
        ...
        <div className="mb-8 flex items-center gap-3 md:hidden">
          ...
          <span className="font-[family-name:var(--font-geist-mono)] text-primary text-2xl font-bold tracking-tight">
            tileforge
          </span>
        </div>

        <Card className="w-full max-w-sm corona-glow">
          <CardContent className="p-8">
            <h2 className="text-center text-xl font-semibold">
              Sign in to{" "}
              <span className="font-[family-name:var(--font-geist-mono)] text-primary">
                tileforge
              </span>
            </h2>
